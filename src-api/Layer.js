...
(function()
{
 ...
 function getFilterAttr(style)
 {
  ...
  if (typeof style.HoverStyle != 'undefined') hoveredStyle = style.HoverStyle;
   ...
   if (hoveredStyle.fill && 'opacity' in hoveredStyle.fill && hoveredStyle.fill.opacity > 0) hoveredStyle.fill.opacity = Math.min(Number(hoveredStyle.fill.opacity + 20), 100);
  }
