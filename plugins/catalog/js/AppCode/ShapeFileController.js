ShapeFileController = function(mapController) {
...
ShapeFileController.prototype = {
	...
	downloadVectorsShapeFile: function(shapes){
    ...
    downloadShapeFile: function(fileName, images) {
        // Search images
    ...
    _getPointWKT: function(p) {
        return (p[0] + '').substring(0, 8) + ' ' + (p[1] + '').substring(0, 8);
    },

    _getSearchWKT: function(objects) {
        var wkts = [];
