...
_translationsHash.hash["rus"] = {
	...
	"Использовать KosmosnimkiAPI" : "Использовать KosmosnimkiAPI",
    ...
    "Отсутствует временной атрибут": "Отсутствует временной атрибут",
    ...
    "Только под перекрестием": "Только под перекрестием",
