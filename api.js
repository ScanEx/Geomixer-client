...
function createFlashMapInternal(div, layers, callback)
{
	...
	var aspBase = "http://" + layers.properties.hostName + "/";
				...
				var createThisLayer = function()
				{
					...
					{	
						...
						if (layer.properties.Quicklook)
							...
							{
								return applyTemplate(layer.properties.Quicklook, o.properties);
							});
						if (layer.properties.TiledQuicklook)
							obj.enableTiledQuicklooks(function(o)
							{
								return applyTemplate(layer.properties.TiledQuicklook, o.properties);
		...
		loadMapJSON(
			...
			function(kosmoLayers)
			{
				createFlashMapInternal(div, kosmoLayers, function(map)
				{
					...
					var mapLayer = map.layers[getBaseMapParam("mapLayerID", KOSMOSNIMKI_LOCALIZED("E50931C3B2DD4E0FA2C03366552EEAA1", "5269E524341E4E7DB9D447C968B20A2C"))];
					...
					map.setMode(mapLayer ? "map" : "satellite");
					map.miniMap.setVisible(true);
					
					if (mapLayer)
						map.miniMap.addLayer(mapLayer);
