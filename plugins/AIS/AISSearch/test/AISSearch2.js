...
/***/ (function(module, exports, __webpack_require__) {
	...
	SpecialFloatView.prototype.show = function (mmsi) {
	
	    var _replaceSubstring = function _replaceSubstring(template, params) {
	        return template.replace(/{[^{}]+}/g, function (key) {
	            return params[key.replace(/[{}]+/g, "")] || "";
	        });
	    };
	
	    var SRC_50LET_TEMPLATE = "//maps.kosmosnimki.ru/plugins/ais/50letpobedy.ashx?n={counter}&r={random}",
	        SRC_DEF_TEMPLATE = "//maps.kosmosnimki.ru/plugins/ais/SCF.ashx?mmsi={mmsi}&n={counter}&r={random}";
	
	    var src = SRC_DEF_TEMPLATE;
	
	    if (mmsi == 273316240) {
	        src = SRC_50LET_TEMPLATE;
	    }
	    ...
	    downloadingImage1.src = _replaceSubstring(src, {
	        'counter': 1,
	        'random': Math.random(),
	        'mmsi': mmsi
	    });
	    ...
	    downloadingImage2.src = _replaceSubstring(src, {
	        'counter': 2,
	        'random': Math.random(),
	        'mmsi': mmsi
	    });
	    ...
	    // UPDATE 
	    //
	    var timer = setTimeout(function update() {
