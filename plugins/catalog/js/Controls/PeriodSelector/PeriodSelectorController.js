PeriodSelectorController = function(targetButton) {
    this._view = null;
...
PeriodSelectorController.prototype = {
    ...
    _initializeYearsSlider: function() {
    ...
    _addTicks: function(target, values) {
